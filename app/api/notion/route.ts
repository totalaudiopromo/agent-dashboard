...
export async function POST(request: NextRequest) {
  try {
        ...
        children: [{
          ...
          callout: {
            rich_text: [{
              type: 'text',
              text: {
                content: `🤖 Auto-Update: MRR: £${data.mrr} | Customers: ${data.customers} | Agents Active: ${data.activeAgents} | ${new Date().toLocaleString()}`
              }
            }],
    ...
    if (action === 'createLayout') {
      // Create Command Center layout functionality
        ...
        children: [
          ...
          // Activity 2
          {
            ...
            callout: {
              rich_text: [{ 
                type: "text", 
                text: { content: "Luna Rivers campaign launched across all platforms | 23:33:41" }
              }],
              icon: { type: "emoji", emoji: "🔵" },
              color: "blue_background"
            }
      ...
      return NextResponse.json({ success: true, message: 'Epic Command Center layout generated!' });
    }
